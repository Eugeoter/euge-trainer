...
def get_config():
    ...
    config.dataset_source = [
        ...
        # dict(
        #     name_or_path="/path/to/condition_images/",
        #     column_mapping={
        #         "image_path": "condition_image_path",
        #     }
        # ),
    ]
    # config.condition_image_type = "canny"
    # config.cache_condition_image = True
    # config.condition_image_cache_dir = "path/to/condition_images/"
    config.condition_image_getter = condition.get_random_inpainting_masked_image_condition
    # config.condition_image_getter_kwargs = dict(
    #     include_body=True,
    #     include_hand=True,
    #     include_face=True,
    # )
