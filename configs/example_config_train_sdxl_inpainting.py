...
def get_config():
    ...
    # Main parameters
    config.pretrained_model_name_or_path = 'Laxhar/noobai-XL-1.1'
    # config.vae_model_name_or_path = 'madebyollin/sdxl-vae-fp16-fix'
    ...
    config.condition_image_getter = condition.get_random_inpainting_mask_condition

    config.output_dir = 'projects/example_train_sdxl_inpainting'
    ...
    config.learning_rate_te1 = 5e-6
    config.learning_rate_te2 = 5e-6
