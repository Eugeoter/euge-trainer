...
class HunyuanDiTControlNeXtPipeline(DiffusionPipeline):
    r"""
    ...
    def prepare_image(
        ...
        return self.vae.encode(image.float()).latent_dist.sample(generator).mul_(self.vae.config.scaling_factor).half()
    ...
    def __call__(
        ...
        # condition = prepare_controlnet_image(
        #     image,
        #     width=width,
        #     height=height,
        ...
        #     do_classifier_free_guidance=self.do_classifier_free_guidance,
        # )
        condition = self.prepare_image(image, generator)
