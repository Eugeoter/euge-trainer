...
from ..models.sd15.controlnext import ControlNeXtModel as ControlNetModel
...
class StableDiffusionControlNeXtPipeline(
    ...
    def __init__(
        ...
        unet: ControlNeXtUNet2DConditionModel,
    ...
    def load_controlnext_unet_weights(
        ...
        **kwargs,
        ...
        print(f"Loading ControlNeXt UNet" + (f" with weight increasement." if load_weight_increasement else "."))
        missing_keys = set(self.unet.state_dict().keys()) - set(state_dict.keys())
        extra_keys = set(state_dict.keys()) - set(self.unet.state_dict().keys())
        ...
        matched_keys = set(state_dict.keys()) & set(self.unet.state_dict().keys())
    ...
    def __call__(
        ...
        **kwargs,
        ...
        assert self.controlnet.dtype == torch.float32, "ControlNeXt must be of dtype torch.float32"
