...
class StableDiffusion3ControlNeXtPipeline(StableDiffusion3Pipeline):
    def __init__(
        self,
        ...
        controlnext: SD3ControlNeXtModel,
    ):
        super().__init__(
    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if controlnet_image is not None:
                    controlnext_output = self.controlnext(controlnet_image, t, return_dict=False)
                    additional_model_inputs["control_signal"] = controlnext_output
