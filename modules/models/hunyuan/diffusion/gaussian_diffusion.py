...
class GaussianDiffusion:
    ...
    def training_losses(self, model, x_start, model_kwargs=None, controlnet=None, noise=None, t=None):
        """
        ...
        if model_kwargs is None:
            model_kwargs = {}
        # Time steps
        t = t if t is not None else th.randint(0, self.num_timesteps, (x_start.shape[0],), device=x_start.device)
        # Noise
        if noise is None:
            noise = th.randn_like(x_start)
