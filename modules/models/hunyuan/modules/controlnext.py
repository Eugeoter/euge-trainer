...
class ControlNetModel(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        self.embedding = nn.Sequential(
            ...
            nn.GroupNorm(2, 64),
            nn.ReLU(),
            nn.Conv2d(64, 64, kernel_size=3, padding=1),  # TODO: set padding=1
            nn.GroupNorm(2, 64),
            nn.ReLU(),
            nn.Conv2d(64, 128, kernel_size=3, padding=1),  # TODO: set padding=1
            nn.GroupNorm(2, 128),
            nn.ReLU(),
            # nn.MaxPool2d(2, 2)
        )
        ...
        # convert (B, 1408, 64, 64) to (B, 1408, 4096)
    ...
    def forward(
        ...
        **kwargs
        ...
        sample = rearrange(sample, "B C P -> B P C")
